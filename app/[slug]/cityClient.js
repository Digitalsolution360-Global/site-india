...
const CATEGORY_CONFIG = {
    ...
    'Digital Marketing': {
        ...
        heroImage: '/digital-marketing-company-digitalsolution360.webp',
        benefits: [
    ...
    'Web Development': {
        ...
        heroImage: '/website-development-and-designing-company-digitalsolution360.webp',
        benefits: [
    ...
    'Social Media': {
        ...
        heroImage: '/social-media-services-digitalsolution360.webp',
        benefits: [
    ...
    'Content Writing': {
        ...
        backLink: '/market-we-serve',
        backLabel: 'Markets We Serve',
        heroImage: '/seo-content-writing-company-digitalsolution360.webp',
        benefits: [
...
const CATEGORY_META = {
    'Google Business': {
        ...
        ogImage: 'https://www.digitalsolution360.in/gmb-og.webp',
    ...
    'Digital Marketing': {
        ...
        ogImage: 'https://www.digitalsolution360.in/digital-marketing-og.webp',
    ...
    'Social Media': {
        ...
        ogImage: 'https://www.digitalsolution360.in/social-media-og.webp',
    ...
    'Content Writing': {
        ...
        ogImage: 'https://www.digitalsolution360.in/content-writing-og.webp',
        ...
        try {
            ...
            await fetch('https://formsubmit.co/ajax/globalweb3600@gmail.com', {
                ...
                body: JSON.stringify({
                    ...
                    _subject: `New Enquiry - ${city?.city || 'City Page'}`, _captcha: 'false', _template: 'table'
                })
            }).catch(() => {});
    ...
    return (
        <>
                ...
                <section className='py-20 px-4 md:px-8 lg:px-16'>
                    <div className='max-w-7xl mx-auto'>
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
                            ...
                            >
                                <img src='/digitalsolution360-our-work.webp' alt={`Why choose us for ${city.category_name} in ${cityName}`} className='w-full h-full object-cover' />
                            </motion.div>
            ...
            {city.city_id == 773 && (  
                    ...
                    >
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.1782574198432!2d77.69020557389437!3d13.024317787295876!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae110026f5869b%3A0x3b2619324f4a4130!2sDigitalsolution360!5e0!3m2!1sen!2sin!4v1775812948628!5m2!1sen!2sin"
                            width="100%"
                            height="500"
                            style={{ border: 0 }}
                            allowFullScreen=""
