    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            await fetch(`${API_URL}/contacts`, {
                ...
                body: JSON.stringify({ name: formData.name, email: formData.email, number: formData.phone, message: formData.message || '[market] Digital Marketing', pageurl: '/market-we-serve/marketing' })
            }).catch(() => {});
            ...
            fd.append('_subject', 'New Enquiry - Digital Marketing Market'); fd.append('_captcha', 'false'); fd.append('_template', 'table');
