              ...
              >
                <Link href={service.link}>
                  <div className='bg-white border border-gray-200 rounded-2xl p-8 h-full shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden'>
                    ...
                    {/* Icon Container */}
                    <div className={`${service.bgColor} w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 relative z-10`}>
